...
valid_fraction = compiled_df.groupby(
    ['model_name', 'direction', 'threshold', 'is_adaptive']
    )['is_valid'].mean()
...
print('\nAverage speed up:')
print(speed_df.groupby(['model_name', 'direction', 'is_adaptive'])['x_speed_up'].mean())

# Print the average MIP gap
print('\nAverage MIP gap:')
print(gap_df.groupby(['model_name', 'direction', 'is_adaptive'])['lp_mip_gap'].mean())

# Print the average feasibility
print('\nAverage feasibility:')
print(valid_fraction_df.groupby(['model_name', 'direction', 'is_adaptive'])['is_valid'].mean())


#%% Plot histogram of k
compiled_df.groupby(
    ['model_name', 'direction', 'is_adaptive']
